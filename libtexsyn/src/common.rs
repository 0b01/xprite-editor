...
impl<F> OrderedFloat<F>
where
    F: Float,
{
    #[allow(unused)]
    pub fn as_float(&self) -> F {
        self.val
    }
...
impl<F> AddAssign for OrderedFloat<F>
where
    F: Float,
{
